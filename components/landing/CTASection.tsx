...
export function CTASection() {
  const router = useRouter(); // Must be inside a client component
  ...
  return (
    <section className="snap-start flex-shrink-0 w-screen h-screen flex flex-col items-center justify-center text-center p-8 bg-black text-green-400 font-mono relative overflow-hidden">
      <motion.div
        className="absolute inset-0 bg-green-900/20 animate-pulse"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.p
        ...
        className="text-lg text-green-200 max-w-xl mb-8"
      >
